...
class VkConversationResponseBody {
  ...
  factory VkConversationResponseBody.fromRawJson(String str) =>
      VkConversationResponseBody.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory VkConversationResponseBody.fromJson(Map<String, dynamic> json) =>
      VkConversationResponseBody(
        response: json["response"] == null
            ? null
            : VkConversationResponse.fromJson(json["response"]),
...
class VkConversationResponse {
  ...
  factory VkConversationResponse.fromRawJson(String str) =>
      VkConversationResponse.fromJson(json.decode(str));
