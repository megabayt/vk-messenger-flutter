...
class VkConversationsResponseBody {
    ...
    factory VkConversationsResponseBody.fromRawJson(String str) => VkConversationsResponseBody.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory VkConversationsResponseBody.fromJson(Map<String, dynamic> json) => VkConversationsResponseBody(
        response: json["response"] == null ? null : VkConversationsResponse.fromJson(json["response"]),
    );
...
class VkConversationsResponse {
    ...
    factory VkConversationsResponse.fromRawJson(String str) => VkConversationsResponse.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory VkConversationsResponse.fromJson(Map<String, dynamic> json) => VkConversationsResponse(
        count: json["count"] == null ? null : json["count"],
        items: json["items"] == null ? null : List<VkConversationItem>.from(json["items"].map((x) => VkConversationItem.fromJson(x))),
...
class VkConversationItem {
    ...
    factory VkConversationItem.fromRawJson(String str) => VkConversationItem.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory VkConversationItem.fromJson(Map<String, dynamic> json) => VkConversationItem(
